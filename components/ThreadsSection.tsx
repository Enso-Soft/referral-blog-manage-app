        ...
        <div className="flex items-center gap-2">
          ...
          {threads.postedAt && (
            <span className="text-xs text-muted-foreground">
              {new Date(
                typeof threads.postedAt === 'object' && 'seconds' in threads.postedAt
                  ? (threads.postedAt as { seconds: number }).seconds * 1000
                  : typeof threads.postedAt === 'object' && '_seconds' in threads.postedAt
                    ? (threads.postedAt as { _seconds: number })._seconds * 1000
                    : String(threads.postedAt)
        ...
        <div className="flex items-center gap-1.5">
          {!editing && (
            <button
              ...
              className="p-1.5 text-muted-foreground hover:text-foreground hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
              title="편집"
            >
        ...
        <div className="space-y-3">
          <div>
            <textarea
              ...
              className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              rows={4}
          ...
          <div className="grid grid-cols-1 gap-2">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 px-2 py-1.5 text-xs border border-gray-200 dark:border-gray-600 rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-muted-foreground hover:text-foreground border border-gray-200 dark:border-gray-600 rounded-lg transition-colors"
            >
      ...
      {!editing && threads.postStatus !== 'posted' && (
        <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
          <button
            onClick={handlePost}
            disabled={posting}
            className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-gray-900 dark:bg-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 rounded-lg transition-colors disabled:opacity-50"
          >
            {posting ? (
